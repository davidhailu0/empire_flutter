...
import 'package:empire_flutter/view/components/code_picker.dart';
...
class CustomTextField extends StatefulWidget {
  ...
  const CustomTextField({
    ...
    this.prefixSize = Dimensions.small,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
                      ...
                      Container(
                        ...
                        decoration: const BoxDecoration(
                          borderRadius: BorderRadius.only(
                            ...
                            bottomLeft: Radius.circular(Dimensions.small),
                          ),
                        ),
        ...
        widget.divider
            ? const Padding(
                padding: EdgeInsets.symmetric(horizontal: Dimensions.large),
                child: Divider())
            : const SizedBox(),
      ],
    );
